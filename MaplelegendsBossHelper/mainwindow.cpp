    ...
    , ui(new Ui::MainWindow)
{
    ...
    for(int i=0;i<monsterList.size();i++)
    {
        ...
        bossUI.bossImage->setGeometry(QRect(bossImagex + spaceBetweenBosses * i,bossImagey,bossImageDimensionx,bossImageDimensiony));
        ...
        bossUI.bossName->setGeometry(QRect(bossNamex + spaceBetweenBosses * i,bossNamey,bossNameDimensionx,bossNameDimensiony));
        ...
        for(int c = 0; c < numCC; c++)
        {
            ...
            bossUI.bossCC[c]->setGeometry(QRect(bossx + spaceBetweenBosses * i,bossy + spaceBetweenBossy * c,bossDimensionx,bossDimensiony));
            ...
            bossUI.timer1BossCC[c]->setGeometry(QRect(timerBossx + spaceBetweenBosses * i,timerBossy + spaceBetweenTimery * c,timerBossDimensionx,timerBossDimensiony));
            ...
            bossUI.timer2BossCC[c]->setGeometry(QRect(timerBossx + spaceBetweenTimerx + spaceBetweenBosses * i,timerBossy + spaceBetweenTimery * c,timerBossDimensionx,timerBossDimensiony));
            ...
            bossUI.button1BossCC[c]->setGeometry(QRect(buttonBossx + spaceBetweenBosses * i,buttonBossy + spaceBetweenButtony * c,buttonBossDimensionx,buttonBossDimensiony));
            ...
            bossUI.button2BossCC[c]->setGeometry(QRect(buttonBossx + spaceBetweenButtonx + spaceBetweenBosses * i,buttonBossy + spaceBetweenButtony * c,buttonBossDimensionx,buttonBossDimensiony));
